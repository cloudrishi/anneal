-- V3 — Create finding_embeddings table for per-finding vector embeddings
--
-- Separate from any future code_embeddings table (file-chunk RAG — reserved).
-- One row per Finding, keyed by finding_id.
--
...
-- Sequence: finding_embeddings_SEQ — created in V1, matches Hibernate default naming.

CREATE TABLE IF NOT EXISTS anneal.finding_embeddings (
    id            BIGINT       NOT NULL DEFAULT nextval('finding_embeddings_SEQ'),
