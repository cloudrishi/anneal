    ...
    async function updateStatus(newStatus: FindingStatus) {
        ...
        try {
            const res = await fetch(
                `${process.env.NEXT_PUBLIC_API_URL}/api/scans/${scanId}/findings/${finding.findingId}`,
                {
                    method: 'PATCH',
            ...
            {expanded && (
                <div style={{padding: '0 14px 14px'}}>
                    ...
                    {finding.llmExplanation ? (
                        ...
                        // Placeholder — enrichment pending, polls will fill this in
                        <div style={{
                            marginBottom: '12px',
                            padding: '10px 12px',
                            background: 'var(--bg)',
